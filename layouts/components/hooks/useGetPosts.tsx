...
export const useGetNetabrePosts = async (setPostData: any) => {
  const databaseRef = collection(database, "posts");
  const netabarePost = query(
    databaseRef,
    where("netabare", "==", "ネタバレ有")
  );
...
export const useGetNoNetabrePosts = async (setPostData: any) => {
  const databaseRef = collection(database, "posts");
  const noNetabarePost = query(
    databaseRef,
    where("netabare", "==", "ネタバレ無")
  );
...
//ユーザーの投稿データを取得
export const useGetMyPosts = async (setPostData: any, myEmail: any) => {
  const databaseRef = collection(database, "posts");
...
//自分がいいねした投稿データを取得
export const useGetLikedPosts = async (setLikedPosts: any, myEmail: any) => {
  const databaseRef = collection(database, "posts");
  const myLikedPosts = query(
    databaseRef,
    where("likes_email", "array-contains", myEmail)
  );
...
//特定のpostを取得
export const useGetPost = async (setSinglePost: any, routerId: any) => {
  try {
...
//特定ユーザーのpostsを取得
export const useGetUsersPosts = async (setPostData: any, userid: any) => {
...
//リロード時にエラーになる
//特定カテゴリの新しい投稿を取得
export const useGetCategoriPosts = async (setPostData: any, postCategori: any) => {
...
//特定カテゴリの古い投稿を取得
export const useGetCategoriOldPosts = async (setPostData: any, postCategori: any) => {
  const postRef = collection(database, "posts");
...
//特定カテゴリのいいね順の投稿を取得
export const useGetCategoriLikePosts = async (setPostData: any, postCategori: any) => {
  const postRef = collection(database, "posts");
  const categoriPosts = query(
    postRef,
    where("categori", "==", postCategori),
