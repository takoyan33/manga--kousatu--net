...
//自分のuserを取得
export const useGetMyUser = async (setUsers: any, userEmail: any) => {
...
//他のuserを取得
export const useGetOtherUser = async (setUsers: any, userid: any) => {
  const usersRef = collection(database, "users");
...
//user全体を取得
export const useGetUsers = async (setUsers: any) => {
  const usersRef = collection(database, "users");
