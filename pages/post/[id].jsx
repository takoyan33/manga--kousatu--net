...
const Post = () => {
  ...
  const addComment = async (data) => {
    ...
    const postRef = await doc(
      database,
      "comments",
      routerid + (comments.length + 1).toString()
    );
                          ...
                          <div key={user.userid}>
                            <div className="m-auto my-4 flex  px-2">
                              ...
                              <div className="ml-6 mt-1">
                                ...
                                <div className="mt-2 pb-2 text-sm text-gray-500">
                                  {user.bio}
                                </div>
                              </div>
                            </div>
              ...
              {!user && (
                <>
                  ...
                  <div className="mb-6 flex items-center justify-between">
                    ...
                    <Link href="/login">
                      <p className="my-6 hover:text-gray-600">
                        ログインするとコメントできます
                      </p>
                    </Link>
                  </div>
                ...
                <section className="bg-white py-8 lg:py-16">
                  <div className="mx-auto max-w-2xl px-4">
                    ...
                    <form className="mb-6" id="aa">
                      ...
                      {errors.comment && (
                        <p className="text-red-500">コメントは必須です</p>
                      )}
                      <button
                        type="submit"
